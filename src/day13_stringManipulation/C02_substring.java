...
public class C02_substring {
    public static void main(String[] args) {
        ...
        // bu arama sonucunda bulunan sonuc sayisi 100'den cok ise "super", az ise "az sonuc bulundu" yazdirsin

        String str= "1-48 of 1453 result for \"nutella\"";


        int ilkSpace= str.indexOf(" ");  // java 4 verecek
