...
public class C02_Default_Static_Method implements I01_Default_Static{
    /*
        Bir interface'de default veya static olarak  tanimlanan ve body'si olan methodlar'in override edilmesi mecburi
        DEGİLDİR(obsiyoneldir)
        Eger static olarak tanimlanmissa zaten OVERRİDE EDEMEYİZ!!!!
        **********STATİC METHODLAR OVERRİDE EDİLEMEZLER***********
    */
